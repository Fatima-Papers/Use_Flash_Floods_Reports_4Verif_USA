...
##############################################################################################################################################
# CODE DESCRIPTION
# 14_Compute_Point_AccRepFF.py creates the accumulated flash flood reports over the same rainfall accumulation periods.
...
# INPUT PARAMETERS
DateTime_Start_S = datetime(2005,1,1,0)
DateTime_Start_F = datetime(2023,12,31,12)
Acc = 12
Disc_Acc = 12
Git_Repo = "/ec/vol/ecpoint_dev/mofp/Papers_2_Write/Use_FlashFloodsRep_4Verif_USA"
FileIN = "Data/Compute/12_Extract_NOAA_Rep/FlashFloodRep.csv"
DirOUT = "Data/Compute/14_Point_AccRepFF"
##############################################################################################################################################
...
while TheDateTime_Start <= DateTime_Start_F:
      ...
      filtered_ff = ff[(ff["BEGIN_DATE_TIME"] >= TheDateTime_Start) & (ff["END_DATE_TIME"] < TheDateTime_Final)]
