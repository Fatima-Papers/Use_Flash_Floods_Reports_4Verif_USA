...
ind_lats_north =  np.where(mask_lats >= 38)[0]
...
for Year in range(Year_S, Year_F+1):
      ...
      for i in range(0, NumGP_all, NumGP_mask):
            ...
            pdt = np.concatenate((temp_ff[ind_lats_north], temp_tp[ind_lats_north], temp_ss[ind_lats_north], temp_slor[ind_lats_north], temp_stdor[ind_lats_north], temp_pd[ind_lats_north]), axis=1)
