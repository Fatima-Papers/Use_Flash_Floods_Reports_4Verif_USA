...
Specification_PDT_list = ["AllRepFF", "NoWestFF", "NoWestGP", "NoEastFF", "NoEastGP"]
xTick_Label_list = ["All RepFF\nFull Domain", "Full Domain\nOnly East RepFF", "Only East Domain", "Full domain\nOnly West RepFF", "Only West Domain"]
# Specification_PDT_list = ["AllRepFF", "NoSouthFF", "NoSouthGP", "NoNorthFF", "NoNorthGP"]
# xTick_Label_list = ["All RepFF\nFull Domain", "Full Domain\nOnly South RepFF", "Only South Domain", "Full domain\nOnly North RepFF", "Only North Domain"]
