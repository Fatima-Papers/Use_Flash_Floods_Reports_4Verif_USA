...
Year_S = 2005
Year_F = 2020
Specification_PDT = "NoNorthGP_NoPopDens_CW"
...
for Year in range(Year_S, Year_F+1):
      ...
      for i in range(0, NumGP_all, NumGP_mask):
            ...
            pdt = np.concatenate((temp_ff[ind_lats_south], temp_tp[ind_lats_south], temp_ss[ind_lats_south], temp_slor[ind_lats_south], temp_stdor[ind_lats_south]), axis=1)
