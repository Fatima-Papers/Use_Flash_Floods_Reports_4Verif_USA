...
###########################################################################
# CODE DESCRIPTION
# 10_Compute_Combine_PDT.py combines the year point data tables to create the unique
# training dataset.
# Runtime: the code takes up to 5 minutes to combine in serial PDTs for 25 years.
...
DirIN = "Data/Compute/09_PDT_Year"
DirOUT = "Data/Compute/10_Combine_PDT"
###########################################################################
...
np.save(MainDirOUT + "/pdt_" + str(Year_S) + "_" + str(Year_F), pdt_all)