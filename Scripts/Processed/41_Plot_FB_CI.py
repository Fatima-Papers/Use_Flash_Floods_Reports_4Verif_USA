...
##########################################################################################
# CODE DESCRIPTION
# 41_Plot_FB_CI.py plots FB and confidence intervals (CI).
...
DirIN = "Data/Compute/40_FB_BS"
DirOUT = "Data/Plot/41_FB_CI"
##########################################################################################
...
for ind in range(len(ROC_list)):
      ...
      FileIN = Git_Repo + "/" + DirIN + "/" + f"{Acc:02d}" + "h/FB_" + f"{Acc:02d}" + "h_" + SystemFC + "_" + str(Perc_VRT) + "_" + ROC + ".npy"
      ...
      ax.plot([StepF[0], StepF[-1]], [1, 1], "-", color="grey", linewidth=2)
      ...
      ax.set_ylabel("FB [-]", fontsize=20, labelpad=10, color="#333333")
...
FileNameOUT_temp = "FB_" + f"{Acc:02d}" + "h_" + SystemFC + "_" + str(Perc_VRT) + ".jpeg"
