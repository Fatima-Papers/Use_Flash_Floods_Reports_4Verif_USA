...
while TheDateTime_Start <= DateTime_Start_F:
      ...
      if TheDateTime_Final.strftime("%H") == "00":
            tp = mv.read(Git_Repo + "/" + DirIN + "/tp/Pt_BC_PERC/" + TheDateTime_Final.strftime("%Y%m") + "/Pt_BC_PERC_" + TheDateTime_Final.strftime("%Y%m%d") + "_24.grib2")
      else:
            tp = mv.read(Git_Repo + "/" + DirIN + "/tp/Pt_BC_PERC/" + TheDateTime_Final.strftime("%Y%m") + "/Pt_BC_PERC_" + TheDateTime_Final.strftime("%Y%m%d") + "_" + TheDateTime_Final.strftime("%H") + ".grib2")
      tp_perc = tp[Perc-1]
