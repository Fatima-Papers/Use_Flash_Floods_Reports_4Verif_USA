...
DirOUT = "Data/Compute/38_Compute_AROC_BS"
###############################################################################################
...
for indStepF in range(len(StepF_list)):
      ...
      while BaseDate <= BaseDateF:
            ...
            FileIN = Git_Repo + "/" + DirIN + "/" + f"{Acc:02d}" + "h/PercVRT_" + str(Perc_VRT) + "/" + SystemFC + "/" + f"{StepF:03d}" + "/Count_FC_OBS_" + f"{Acc:02d}" + "h_PercVRT_" + str(Perc_VRT) + "_" + SystemFC + "_" + BaseDate.strftime("%Y%m%d") + "_" + BaseDate.strftime("%H") + "_" + f"{StepF:03d}" + ".csv.npy"
            ...
            if os.path.isfile(FileIN): # proceed if the files exists
                  ...
                  Count_OBS_original.append(Count_EM_OBS[2].tolist())
...
FileNameOUT_temp = "AROC_" + f"{Acc:02d}" + "h_" + SystemFC + "_" + str(Perc_VRT)
