...
for Year in range(Year_S, Year_F+1):
      ...
      for i in range(0, NumGP_all, NumGP_mask):
            ...
            pdt = np.concatenate((temp_ff[ind_lons_west], temp_tp[ind_lons_west], temp_ss[ind_lons_west], temp_slor[ind_lons_west], temp_stdor[ind_lons_west], temp_pd[ind_lons_west]), axis=1)
