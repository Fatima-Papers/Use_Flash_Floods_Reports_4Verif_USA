...
for Year in range(Year_S, Year_F+1):
      ...
      for i in range(0, NumGP_all, NumGP_mask):
            ...
            pdt = np.concatenate((temp_ff[ind_lats_south], temp_tp[ind_lats_south], temp_ss[ind_lats_south], temp_slor[ind_lats_south], temp_stdor[ind_lats_south], temp_pd[ind_lats_south]), axis=1)
