...
ind_lon_east =  np.where(mask_lons > -100)[0]
...
for Year in range(Year_S, Year_F+1):
      ...
      for i in range(0, NumGP_all, NumGP_mask):
            ...
            pdt = np.concatenate((temp_ff[ind_lon_east], temp_tp[ind_lon_east], temp_ss[ind_lon_east], temp_slor[ind_lon_east], temp_stdor[ind_lon_east], temp_pd[ind_lon_east]), axis=1)
