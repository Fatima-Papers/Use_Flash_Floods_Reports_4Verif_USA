...
FileIN = Git_Repo + "/" + DirIN + "/" + f"{Acc:02d}" + "h/AROC_" + f"{Acc:02d}" + "h_" + SystemFC + "_" + str(Perc_VRT) + ".npy"
...
ax.plot(StepF, aroc_real, "o-", color=Colour_SystemFC, label=SystemFC, linewidth=3)
