...
################################################################################
# CODE DESCRIPTION
# 04_Plot_PopDens.py plots population density.
# Runtime: negligible.
...
DirIN = "Data/Compute/03_Extract_Raw_Regridded_PopDens"
DirOUT = "Data/Plot/04_PopDens"
################################################################################
...
for Year in range(Year_S, Year_F+1, Disc_Year):
    ...
    mv.setoutput(png)
    mv.plot(geo_view, pop_dens_mask, contouring, coastlines, legend, title)
