...
##########################################################################
# CODE DESCRIPTION
# Retrieve_Analysis_ERA5_swvl.sh retrieves from MARS the volumetric soil water from 
# ERA5 (31 km resolution).
# Runtime: the code takes up tp 10 hours to run in serial.
